...
export class AngularGooglePlaceService {
    ...
    private find(address_components: Array<any>, query: string, val: string = null) {
    ...
    street_number(address_components: Array<any>) {
        return this.find(address_components, 'street_number', 'long_name');
    }

    address(address_components: Array<any>) {
        let arr = []
        arr.push(this.street(address_components))
        let street_number = this.street_number(address_components)
        if (street_number) {
